...
ptx_target_arch = 60  # target architecture for PTX generation, defaults to the lowest architecture that supports all of Warp's features
...
build = False  # whether to build the kernels
